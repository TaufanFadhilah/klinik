...
class jadwal extends CI_Controller {
	...
	public function do_input(){
		...
		$data['check_extra'] = $this->db->query("Select * from schedule JOIN registration on schedule.idregistration = registration.idregistration where iduser = '$id' AND extra = '0' AND YEAR(date_time) = '$year' AND MONTH(date_time) = '$month'")->result_array();
